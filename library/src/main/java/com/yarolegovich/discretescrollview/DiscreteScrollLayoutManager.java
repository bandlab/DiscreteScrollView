...
class DiscreteScrollLayoutManager extends RecyclerView.LayoutManager {
    ...
    protected void layoutView(RecyclerView.Recycler recycler, int position, Point viewCenter) {
        ...
        if (v == null) {
            try {
                Log.i("DiscreteScrollLayoutMan", String.format(
                        "layoutView(recycler, %d, %s) and view is null", position, viewCenter.toString()
                ));
                ...
                Log.i("DiscreteScrollLayoutMan", "layoutView is failed", t);
            }
        } else {
